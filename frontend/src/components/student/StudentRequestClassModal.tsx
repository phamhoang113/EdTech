...
import '../parent/RequestClassModal.css';
...
function MapAddressInput({ value, onChange }: { value: string; onChange: (v: string, lat?: number, lon?: number) => void }) {
...
export function StudentRequestClassModal({ onClose, onSuccess }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await studentApi.createClassRequest({
