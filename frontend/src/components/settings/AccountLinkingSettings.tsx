  ...
  return (
    <div className="account-linking-settings">
      ...
      <div className="linking-list">
        <div className={`linking-item ${hasGoogle ? 'linking-item--linked' : ''}`}>
          ...
          {hasGoogle ? (
            <div className="linked-status">
              <span className="linked-badge"><Check size={14} /> Đã liên kết</span>
              <button className="unlink-text-btn" onClick={() => handleUnlink('google')}>Hủy liên kết</button>
            </div>
          ) : (
        ...
        <div className={`linking-item ${hasFacebook ? 'linking-item--linked' : ''}`}>
          <div className="linking-item-info">
          ...
          {hasFacebook ? (
            <div className="linked-status">
              <span className="linked-badge"><Check size={14} /> Đã liên kết</span>
              <button className="unlink-text-btn" onClick={() => handleUnlink('facebook')}>Hủy liên kết</button>
            </div>
          ) : (
