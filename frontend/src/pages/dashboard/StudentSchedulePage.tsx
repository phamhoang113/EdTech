import { CalendarIcon, Clock, Video, Info, AlertCircle, XCircle } from 'lucide-react';
...
export function StudentSchedulePage() {
  ...
  const submitCancel = async () => {
    ...
    setSubmitting(true);
    try {
      await studentApi.cancelSession(cancelTarget.id, {
        reason: cancelReason,
        makeUpRequired,
      });
      ...
      <div className="psched-container">
            ...
            <div className="psched-header-section">
              <div className="psched-header">
                <h1 className="psched-title">Lịch học của tôi</h1>
                <p className="psched-subtitle">Theo dõi lịch học trong tuần</p>
              </div>
