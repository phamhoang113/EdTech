...
var mcafee_wa_bkconstants = 
{
    ...
    siteReportUrl           : "https://www.trellix.com/threat-intelligence/site/default.aspx?url=",
...
mcafee_wa_popup.prototype.init = function ()
{
    ...
    document.addEventListener('DOMContentLoaded',  function () 
    {
        chrome.tabs.query({'active' : true, 'currentWindow' : true }, function (tabs)
         {
			// Removed calling background pages which are not available in MV3, handled the case using extension message passing
			 var res_id = "res_" + mcafee_wa_resources.IDS_VIEWSITEREPORT;
			 chrome.runtime.sendMessage({command:"getres",resid:res_id}, function (sitereport)
				{
